...
Blazium's audio processing code has been written with games in mind, with the aim
of achieving an optimal balance between performance and sound quality.

Blazium's audio engine allows any number of audio buses to be created and any
...
Blazium's sound interface is designed to meet the expectations of sound design
...
Audio buses can be found in the bottom panel of the Blazium editor:
...
There is no need to disable buses manually when not in use. Blazium detects
