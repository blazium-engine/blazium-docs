...
There are two types of icons required by Blazium:
...
If you don't provide some of the requested icons, Blazium will replace them using a fallback chain, trying the next in line when the current one fails:
