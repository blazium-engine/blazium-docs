...
C# as an option for a scripting language, alongside Blazium's own :ref:`GDScript<toc-learn-scripting-gdscript>`.
...
- Projects targeting Android need to target .NET 7.0 or higher. This requires
  modifying the `.csproj` file generated by Blazium for existing projects.
