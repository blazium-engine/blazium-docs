...
but if you need to build these bindings for a newer version of Blazium, call
the Blazium executable:
...
You should also set the minimum compatible Blazium version with ``compatibility_minimum``,
