...
Blazium supports hundreds of controller models thanks to the community-sourced
...
You can contribute an updated mapping to be included in the next Blazium version
