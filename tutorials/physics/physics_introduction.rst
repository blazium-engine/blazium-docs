...
Blazium offers a number of collision objects in 2D and 3D to provide both collision detection
...
-   Blazium's four collision object types
...
Blazium offers four kinds of collision objects which all extend :ref:`CollisionObject2D <class_CollisionObject2D>`.
...
It is important that all physics related code runs at this fixed rate. Therefore, Blazium
...
tick is called physics processing. Blazium provides two different callbacks, one for each
