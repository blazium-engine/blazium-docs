...
In Blazium, physics simulation and rendering both rely on *floating-point* numbers.
...
To avoid model snapping issues when far away from the world origin, Blazium's 3D
