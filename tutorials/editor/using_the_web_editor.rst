...
There is a `Web editor <https://editor-nightly.blazium.app/>`__
...
Due to limitations on the Blazium or Web platform side, the following features
...
- No project exporting. As a workaround, you can download the project source
  ...
  `native version of the Blazium editor <https://blazium.app/download>`__.
...
- No lightmap baking support. You can still use existing lightmaps if they were
  baked with a native version of the Blazium editor
...
- Run the editor by clicking **Start Blazium editor**.
  The Blazium Project Manager should appear after 10-20 seconds.
...
Unlike the native version of Blazium, the web editor is constrained to a single
...
project using a `native Blazium editor <https://blazium.app/download>`__,
