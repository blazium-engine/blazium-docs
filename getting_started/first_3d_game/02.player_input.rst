...
.. note::
    ...
    like FBX, which Blazium also supports. To produce these files, we designed the
...
arrow keys. In Blazium, while we could write all the key bindings in code, there's
...
Blazium projects come with some predefined actions designed for user interface
