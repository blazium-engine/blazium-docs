...
there is an import plugin available in Blazium for it. Or you can create one, like the `Tiled
...
*RPG in a Box is a voxel RPG editor made with Godot 2. It uses Blazium's
