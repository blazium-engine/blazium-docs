...
.. XML source: https://github.com/blazium-engine/blazium/tree/4.3/doc/classes/TabBar.xml.
...
.. table::
   ...
   +-----------------------------------+------------------------------------------------------------------------------+-------------------------------------+
   | :ref:`Color<class_Color>`         | :ref:`font_unselected_color<class_TabBar_theme_color_font_unselected_color>` | ``Color(0.875, 0.875, 0.875, 0.8)`` |
   +-----------------------------------+------------------------------------------------------------------------------+-------------------------------------+
...
:ref:`Color<class_Color>` **font_unselected_color** = ``Color(0.875, 0.875, 0.875, 0.8)`` :ref:`🔗<class_TabBar_theme_color_font_unselected_color>`
