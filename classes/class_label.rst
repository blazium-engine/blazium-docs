...
.. XML source: https://github.com/blazium-engine/blazium/tree/4.3/doc/classes/Label.xml.
...
.. table::
   ...
   +---------------------------------+----------------------------------------------------------------------------+-------------------------------------+
   | :ref:`Color<class_Color>`       | :ref:`font_color<class_Label_theme_color_font_color>`                      | ``Color(0.875, 0.875, 0.875, 0.8)`` |
   +---------------------------------+----------------------------------------------------------------------------+-------------------------------------+
...
:ref:`Color<class_Color>` **font_color** = ``Color(0.875, 0.875, 0.875, 0.8)`` :ref:`🔗<class_Label_theme_color_font_color>`
