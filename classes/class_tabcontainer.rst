...
.. table::
   ...
   +-----------------------------------+------------------------------------------------------------------------------------+-------------------------------------+
   | :ref:`Color<class_Color>`         | :ref:`font_unselected_color<class_TabContainer_theme_color_font_unselected_color>` | ``Color(0.875, 0.875, 0.875, 0.8)`` |
   +-----------------------------------+------------------------------------------------------------------------------------+-------------------------------------+
...
:ref:`Color<class_Color>` **font_unselected_color** = ``Color(0.875, 0.875, 0.875, 0.8)`` :ref:`🔗<class_TabContainer_theme_color_font_unselected_color>`
