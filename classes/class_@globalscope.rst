...
.. XML source: https://github.com/blazium-engine/blazium/tree/4.3/doc/classes/@GlobalScope.xml.
...
\ **Note:** If a built-in method returns this code, please open an issue on `the GitHub Issue Tracker <https://github.com/blazium-engine/blazium/issues>`__.
...
The :ref:`Steam<class_Steam>` singleton.
