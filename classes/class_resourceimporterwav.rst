...
.. XML source: https://github.com/blazium-engine/blazium/tree/4.3/doc/classes/ResourceImporterWAV.xml.
...
WAV/AIFF is an uncompressed format, which can provide higher quality compared to Ogg Vorbis and MP3. It also has the lowest CPU cost to decode. This means high numbers of sounds can be played at the same time, even on low-end devices.
